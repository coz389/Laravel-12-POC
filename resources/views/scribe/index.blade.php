    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="authentication">
                    <a href="#authentication">Authentication</a>
                                ...
                                <a href="#authentication-POSTapi-register">User Sign Up</a>
                            </li>
                ...
                <li class="tocify-item level-1" data-unique="user-management">
                    <a href="#user-management">User Management</a>
                                ...
                                <a href="#user-management-GETapi-users">Get User List</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="user-management-GETapi-users--user_id-">
                                <a href="#user-management-GETapi-users--user_id-">Get Individual User</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="user-management-PUTapi-users--user_id-">
                                <a href="#user-management-PUTapi-users--user_id-">Update User</a>
                            </li>
...
<p>You can retrieve your token by visiting your dashboard and clicking <b>Generate API token</b>.</p>
    ...
    <p>APIs for managing user registration and login access.</p>

                                <h2 id="authentication-POSTapi-register">User Sign Up</h2>

<p>
</p>

<p>This endpoint allows new users to create an account and receive an access token.</p>
...
<p>Authenticate user credentials and return a Bearer Token.</p>
...
<p>Revoke the current access token to log out the user.</p>
...
<p>Example: <code>application/json</code></p>
                ...
                <h1 id="user-management">User Management</h1>
                                ...
                                <h2 id="user-management-GETapi-users">Get User List</h2>
...
<p>The page number. Example: <code>1</code></p>
                    ...
                    <h2 id="user-management-GETapi-users--user_id-">Get Individual User</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Fetch details of a specific user.</p>
...
<p>The ID of the user. Example: <code>1</code></p>
                    ...
                    <h2 id="user-management-PUTapi-users--user_id-">Update User</h2>
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>A unique email address. Example: <code>gbailey@example.net</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>password</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
